exports.deleteAccountEmail = (email, firstName, lastName, deletionDate) => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Account Scheduled for Deletion – Resume Enhancer</title>
</head>
    ...
    <tr>
      <td align="center" style="padding:48px 16px;">
        ...
        <table width="600" cellpadding="0" cellspacing="0"
          ...
          <!-- Top accent bar -->
          <tr>
            <td style="background:linear-gradient(90deg,#F97316,#EF4444);height:5px;font-size:0;line-height:0;">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td style="padding:40px 48px;">
              ...
              <p style="margin:0 0 32px;text-align:center;color:#9CA3AF;font-size:15px;line-height:1.65;">
                ...
                we've received your request to delete your account. Your account has been
                <strong style="color:#F97316;">suspended</strong> and will be permanently
                deleted after <strong style="color:#F9FAFB;">2 days</strong>.
              </p>
              ...
              <div style="background:#0D1117;border-radius:14px;overflow:hidden;margin:0 0 28px;
                ...
                <div style="padding:12px 20px;background:#1C2130;border-bottom:1px solid #2C333F;">
                  <span style="font-size:11px;font-weight:700;color:#F97316;letter-spacing:2px;
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="padding:13px 20px;border-bottom:1px solid #1C2130;width:40%;">
                  ...
                  <tr>
                    <td style="padding:13px 20px;">
                      <span style="font-size:13px;color:#6B7280;">Deletion Date</span>
                    </td>
                    <td style="padding:13px 20px;">
                      <span style="font-size:13px;color:#F9FAFB;">${deletionDate}</span>
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <!-- Recovery notice -->
              <div style="background:#22C55E10;border-radius:12px;padding:16px 20px;
                          border:1px solid #22C55E30;text-align:center;">
                <span style="font-size:14px;color:#86EFAC;">
                  ✅ Changed your mind? Simply
                  <strong style="color:#F9FAFB;">log back in before ${deletionDate}</strong>
                  to recover your account instantly.
                </span>
              </div>
            </td>
          </tr>
