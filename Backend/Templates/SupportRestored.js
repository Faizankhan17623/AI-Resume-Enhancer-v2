...
// sent when a suspended Support account is un-banned sir — controllers/Admin.js's banUser,
// only for role: 'Support' (mirrors SupportSuspended.js, the suspension-side email)
exports.supportRestoredTemplate = (name) => {
...
<head>
  ...
  <title>Your Support Account Has Been Restored – Resume Enhancer</title>
</head>
          ...
          <tr>
            <td style="padding:40px 48px;">
              ...
              <h1 style="margin:0 0 10px;text-align:center;font-size:24px;font-weight:700;
                ...
                Good news, ${name} — your account has been restored
              </h1>
              <p style="margin:0 0 28px;text-align:center;color:#9CA3AF;font-size:15px;line-height:1.65;">
                An administrator has lifted your suspension. You can sign in and access the
                Support dashboard normally again.
              </p>
